...
from app.agents.tools.wolfram_alpha_withLLM import WolframAlphaAPIWrapper
...
def create_agent(websocket: WebSocket, chatlog: str):
    ...
    tools = [
        ...
        Tool(
            name="Olympic games QA System",
            func=olympics_qa.run,
            description="""
            useful for when you need to answer questions about the olympic games. 
